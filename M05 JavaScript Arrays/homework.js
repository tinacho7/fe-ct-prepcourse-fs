...
function promedioResultadosTest(resultadosTest) {
   ...
   var promNotas = sumaNotas / resultadosTest.length;
   return promNotas;
}
...
function mesesDelAño(array) {
   ...
   for (var i = 0 ; i < array.length ; i++){
      if (array.includes('Enero') == true && array.includes('Marzo') == true && array.includes('Noviembre') == true){
